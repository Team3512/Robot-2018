...
void Robot::TeleopPeriodic() {
    ...
    switch (eleMode) {
        case ElevatorMode::kPositionMode:  // TODO: change the Height
            ...
            if (appendageStick.GetRawButtonPressed(12)) {
                elevator.StopClosedLoop();
                eleMode = ElevatorMode::kVelocityMode;
            }
            break;
        case ElevatorMode::kVelocityMode:
            if (!elevator.GetHallEffect()) {
                elevator.ResetEncoder();
                elevator.SetVelocity(0); // TODO: get rid of this when CANTalonGroup's limit switches work
                if (appendageStick.GetY() < 0) { // TODO: this too
            ...
            if (appendageStick.GetRawButtonPressed(12)) {
                ...
                elevator.StartClosedLoop();
                eleMode = ElevatorMode::kPositionMode;
            }
    }
