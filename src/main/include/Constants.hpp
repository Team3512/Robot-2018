...
constexpr units::inch_t kWheelbaseWidth = 24_in;
constexpr auto kRobotLength = 37_in;  // Approximate
constexpr auto kRobotWidth = 33_in;   // Approximate
...
constexpr units::inch_t kExchangeOffset = kRobotWidth / 2.0 - 12_in;
