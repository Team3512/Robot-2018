 ...
 */
TrajectoryProfile::TrajectoryProfile(double maxV, double maxA, double timeToMaxA) {
  SetMaxVelocity(maxV);
 ...
 */
void TrajectoryProfile::SetGoal(double goal, double currentSource) {
 ...
 */
void TrajectoryProfile::SetMaxVelocity(double velocity) {
  std::lock_guard<std::mutex> lock(m_mutex);
 ...
 */
double TrajectoryProfile::GetMaxVelocity() const {
  std::lock_guard<std::mutex> lock(m_mutex);
 ...
 */
void TrajectoryProfile::SetMaxAcceleration(double acceleration) {
  std::lock_guard<std::mutex> lock(m_mutex);
 ...
 */
void TrajectoryProfile::SetTimeToMaxA(double timeToMaxA) {
  std::lock_guard<std::mutex> lock(m_mutex);
  m_timeToMaxA = timeToMaxA;
  m_jerk = m_acceleration / m_timeToMaxA;
}

MotionProfile::State TrajectoryProfile::UpdateSetpoint(double currentTime) {
  std::lock_guard<std::mutex> lock(m_mutex);
