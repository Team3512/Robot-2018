...
void DiffDriveController::Debug() {
    ...
    Robot::liveGrapher.GraphData(m_positionRef.GetVelocityNode().GetOutput(), "Velocity Reference");
    Robot::liveGrapher.GraphData(m_angleRef.GetVelocityNode().GetOutput(), "Angle Rate Reference");
}
