...
public:
    ...
    // Returns the status of the shifting solenoid
    ...
    // Gets the status of the pawl solenoid
    bool GetPawl() const;
    ...
    double GetSimulatedPosition() const;

    double GetSimulatedVelocity() const;
