...
constexpr double kPosP = 0.00;            // 0.07
constexpr double kPosI = 0.00;            // 0.00
constexpr double kPosD = 0.00;            // 0.08
...
// Talon IDs
constexpr int kIntakeLeftID = 1;
constexpr int kIntakeRightID = 2;
...
// Elevator GearBox ID
constexpr int kElevatorMasterID = 5;
constexpr int kElevatorSlaveID = 6;
