...
void DiffDriveController::Debug() {
    ...
    //                             "Angle Reference");
    //Robot::liveGrapher.GraphData(m_rightEncoder.GetOutput(), "Right Encoder");
    //Robot::liveGrapher.GraphData(m_leftEncoder.GetOutput(), "Left Encoder");
    Robot::liveGrapher.GraphData((m_leftEncoder.GetOutput() + m_rightEncoder.GetOutput()) / 2, "Encoder Average");
    ...
    std::cout << "InTolerance: " << m_positionError.InTolerance() << " AtGoal: " << m_positionRef.AtGoal() << std::endl;
}
