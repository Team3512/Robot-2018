...
double DriveTrain::PositionProfileTimeTotal() const { return m_posRef.ProfileTimeTotal(); }

double DriveTrain::AngleProfileTimeTotal() const { return m_angleRef.ProfileTimeTotal(); }
